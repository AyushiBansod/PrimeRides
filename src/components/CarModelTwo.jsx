...
const CarModel = ({ path, scale = 1 }) => {
  ...
  return (
    <primitive
      object={scene}
      scale={scale}
      position={[0, -2.1, 0]} // Move the model downwards along the Y-axis
      rotation={[0, -Math.PI / 2, 0]} // Rotate the car to face the right side
    />
  );
};

useGLTF.preload("/modeltwo.glb");
  ...
  return (
    <div className="canvas-container">
      ...
      >
        ...
        <CarModel path="/modeltwo.glb" scale={0.9} />
        <OrbitControls
          enableZoom={true}
          enablePan={false}
